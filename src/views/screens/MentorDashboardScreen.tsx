...
const styles = StyleSheet.create({
  ...
  greetingTitle: { fontSize: 16, fontWeight: '800' },
  greetingRole: { fontSize: 11, fontWeight: '700' },
  dutyPill: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  dutyPillText: { fontSize: 11, fontWeight: '700' },
  heroBottomRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  talukaLeadText: { fontSize: 11, fontWeight: '700' },
  ...
  metricValue: { fontSize: 20, fontWeight: '800', lineHeight: 24 },
  metricLabelSingle: {
    fontSize: 11,
    fontWeight: '700',
    marginTop: 4,
  ...
  utilityBtnText: { fontSize: 12, fontWeight: '600' },
  sectionHeaderRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  sectionSubtitle: { fontSize: 11, fontWeight: '700' },
  ...
  caseCode: { fontSize: 11, fontWeight: '700', fontFamily: 'monospace' },
  ...
  bloodTypeLetter: { fontSize: 14, fontWeight: '800' },
  feedCardTitle: { fontSize: 14, fontWeight: '700', lineHeight: 18 },
  feedCardCitizen: { fontSize: 13, fontWeight: '600', marginTop: 2 },
  feedCardLoc: { fontSize: 11, marginTop: 2 },
  feedCardAlertDesc: { fontSize: 11, fontWeight: '600', marginTop: 3 },
  citizenContactStrip: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  impactTitle: { fontSize: 13, fontWeight: '800' },
  impactSub: { fontSize: 11, marginTop: 1 },
});
