...
const styles = StyleSheet.create({
  ...
  subBannerTitle: { fontSize: 18, fontWeight: '800' },
  subBannerDesc: { fontSize: 13, marginTop: 2 },
  dutyTag: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  dutyTagText: { fontSize: 13, fontWeight: '700' },
  ...
  filterCountText: { fontSize: 13, fontWeight: '800' },
  ...
  sectorChipText: { fontSize: 14, fontWeight: '600' },
  cardFeed: { gap: 12 },
  emptyCard: {
    padding: 30,
    borderRadius: 16,
  ...
  caseCodeText: { fontSize: 14, fontWeight: '800', fontFamily: 'monospace' },
  criticalPill: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  criticalPillText: { fontSize: 12, fontWeight: '800' },
  sectorIconBox: {
    width: 32,
    height: 32,
    borderRadius: 8,
  ...
  taskSubGu: { fontSize: 13, marginTop: 1 },
  citizenBox: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  citizenAvatarText: { fontSize: 16, fontWeight: '800' },
  citizenName: { fontSize: 15, fontWeight: '700' },
  citizenLocationRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 3,
  ...
  updateCtaText: { color: '#ffffff', fontSize: 15, fontWeight: '700' },
});
