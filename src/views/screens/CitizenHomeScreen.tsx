...
const styles = StyleSheet.create({
  ...
  greetingMain: { fontSize: 22, fontWeight: '800' },
  greetingSubRow: { flexDirection: 'row', alignItems: 'center', marginTop: 3 },
  greetingLoc: { fontSize: 14, fontWeight: '600', marginLeft: 3 },
  sosRaktBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  sosRaktText: { fontSize: 14, fontWeight: '700', color: '#dc2626' },
  canopyCard: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  ...
  canopyTitle: { fontSize: 15, fontWeight: '700' },
  canopyDesc: { fontSize: 13, marginTop: 2 },
  activeCard: {
    borderRadius: 16,
    padding: 16,
    borderWidth: 1,
  ...
  kickerText: { fontSize: 12, fontWeight: '800', letterSpacing: 0.6 },
  caseTitle: { fontSize: 18, fontWeight: '700' },
  caseNo: { fontSize: 14, marginTop: 2, fontWeight: '600' },
  ...
  deepActionText: { fontSize: 14, fontWeight: '700' },
  emptyCard: {
    alignItems: 'center',
    justifyContent: 'center',
    padding: 24,
  ...
  sectorCardTitle: { fontSize: 15, fontWeight: '700' },
  sectorCountText: { fontSize: 12.5, marginTop: 1 },
  sectorApplyLink: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  sectorApplyText: { fontSize: 13, fontWeight: '700' },
  otherRequestCard: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  ...
  otherReqCase: { fontSize: 15, fontWeight: '700' },
  otherReqTitle: { fontSize: 14 },
});
