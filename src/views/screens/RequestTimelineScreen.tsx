...
const styles = StyleSheet.create({
  ...
  caseTitle: { fontSize: 19, fontWeight: '800', lineHeight: 26 },
  caseSubGu: { fontSize: 14, marginTop: 2 },
  statusLivePill: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 5,
  ...
  statusLiveText: { fontSize: 13, fontWeight: '700' },
  applicantMetaRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  locationMetaText: { fontSize: 14 },
  descBox: { padding: 10, borderRadius: 10, gap: 4 },
  descTitle: { fontSize: 13, fontWeight: '700' },
  descContent: { fontSize: 15, lineHeight: 20 },
  officerHeaderRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  },
  officerLabel: { fontSize: 14, fontWeight: '700' },
  dutyPill: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  dutyTextSmall: { fontSize: 12, fontWeight: '700' },
  ...
  officerAvatarText: { fontSize: 20, fontWeight: '800' },
  ...
  officerName: { fontSize: 17, fontWeight: '800' },
  officerRole: { fontSize: 14 },
  ...
  pendingOfficerTitle: { fontSize: 16, fontWeight: '700' },
  pendingOfficerSub: { fontSize: 14, marginTop: 2, lineHeight: 18 },
  progressHeaderRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  stepsCountText: { fontSize: 13, fontWeight: '700' },
  ...
  stepTitleText: { fontSize: 15, fontWeight: '700', flex: 1 },
  stepTimeText: { fontSize: 13 },
  stepDescText: { fontSize: 14, lineHeight: 19 },
  systemVerifiedRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  systemVerifiedText: { fontSize: 13, fontWeight: '600' },
