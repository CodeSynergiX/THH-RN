...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 13, fontWeight: '700' },
  ...
  overviewH1: { fontSize: 20, fontWeight: '800' },
  newReqBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  newReqBtnText: { fontSize: 14, fontWeight: '700' },
  overviewDesc: { fontSize: 14, lineHeight: 18 },
  segmentedTabs: {
    flexDirection: 'row',
    borderRadius: 12,
    padding: 4,
  ...
  segmentTabText: { fontSize: 13, fontWeight: '700' },
  cardList: { gap: 14 },
  loadingBox: {
    borderRadius: 16,
    padding: 36,
  ...
  sectorTagText: { fontSize: 12, fontWeight: '700' },
  caseNoText: { fontSize: 13, fontWeight: '600', fontFamily: 'monospace' },
  appTitle: { fontSize: 17, fontWeight: '700' },
  statusPulsingBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 5,
  ...
  statusPulsingText: { fontSize: 13, fontWeight: '700' },
  subDetailsRow: {
    flexDirection: 'row',
    alignItems: 'center',
    padding: 8,
  ...
  viewTimelineText: { fontSize: 14, fontWeight: '700' },
  contactOfficerBtn: {
  ...
  contactOfficerText: { fontSize: 14, fontWeight: '700' },
});
